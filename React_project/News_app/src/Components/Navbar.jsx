  ...
  return (
    ...
    >
      <Container maxWidth="xl">
        <Toolbar disableGutters className="flex flex-wrap justify-between items-center py-3">
          <Box className="flex items-center gap-3 cursor-pointer group" onClick={() => handleCategoryClick('general')}>
          ...
          <Box className="flex flex-wrap gap-2 mt-3 md:mt-0">
